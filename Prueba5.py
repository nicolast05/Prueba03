...
class Window(Frame):
    ...
    def init_window(self):
        ...
        # Lista
        self.lista = Listbox(self.master, font=(
            "Helvetica", 8), borderwidth=0, activestyle=NONE, yscrollcommand=self.scrollbar.set)
    ...
    def openFile(self):
        ...
        switchCommentOn = 'N'
        listBlockBD = [use]
        listBlockHeader = [if_, exists, from_, sysobjects,
                           objectid_, and_, type_, drop, procedure]
        ...
        listObjects = []
        listConstants = [use, if_, exists, from_, sysobjects, objectid_,
                         and_, type_, drop, procedure, create, grant, execute]
        listStatements = [usp]
        listParameters = ['@']
            ...
            with open(filepath) as fp:
                ...
                while line:
                    ...
                    if strippedLine == go:
                        ...
                        listBlock.clear()  # aca se llenan constantes y variables
                        ...
                        if indexBlockComentOpen >= 0 or switchCommentOn == 'S':
                            indexBlockComentClose = line.find(
                                blockCommentClose, beg)
